...
export class Convert {
    public static toLottery(json: string): Lottery[] {
        return cast(JSON.parse(json), a(r("Lottery")));
    }

    public static lotteryToJson(value: Lottery[]): string {
        return JSON.stringify(uncast(value, a(r("Lottery"))), null, 2);
    }
}
...
const typeMap: any = {
    "Lottery": o([
        { json: "id", js: "id", typ: 0 },
        { json: "ticket_number", js: "ticket_number", typ: "" },
        { json: "price", js: "price", typ: "" },
        { json: "period", js: "period", typ: 0 },
        { json: "set_number", js: "set_number", typ: "" },
